...
CREATE TABLE `comments` (
  ...
  `gab_id` bigint unsigned NOT NULL,
  `in_reply_to_id` bigint unsigned DEFAULT NULL,
  `content` text,
  `id_gab_users` int DEFAULT NULL,
  `replies_count` int DEFAULT NULL,
  `reblogs_count` int DEFAULT NULL,
  `created_at` timestamp(3) NULL DEFAULT NULL,
  `revised_at` timestamp(3) NULL DEFAULT NULL,
...
-- Dump completed on 2022-04-09 20:24:53
